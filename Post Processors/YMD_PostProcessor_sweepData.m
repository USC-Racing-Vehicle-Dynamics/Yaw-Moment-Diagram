...
data(1) = load('YMD Sweep Results/YMD_sweepCoP_20mph.mat');
data(2) = load('YMD Sweep Results/YMD_sweepCoP_40mph.mat');
data(3) = load('YMD Sweep Results/YMD_sweepCoP_60mph.mat');
...
nexttile; hold on;
plot(sweepVarValue, grip.M_avg, '-o');
xlabel(sweepVarName); 
