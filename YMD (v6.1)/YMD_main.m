...
rangeField.SXField1.Value = -1;
rangeField.SXField1.Limits = [-1 1];
...
rangeField.SXField2.Value = 1;
rangeField.SXField2.Limits = [-1 1];
...
exportPlotButton.ButtonPushedFcn = @(src, event) YMD_progress(6);
